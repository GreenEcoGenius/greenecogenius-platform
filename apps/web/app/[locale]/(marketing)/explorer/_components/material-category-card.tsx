...
export function MaterialCategoryCard({
  ...
  const content = (
    <>
      ...
      <div className="text-[#F5F5F0] mb-1 text-2xl font-bold">
        {formatVolume(stat.annual_volume_tonnes)}
        <span className="text-[#5A9E7D] text-sm font-normal">
          {t('explorer.perYear')}
        </span>
      </div>

      <div className="text-[#7DC4A0] mt-2 flex flex-wrap gap-x-4 gap-y-1 text-xs">
