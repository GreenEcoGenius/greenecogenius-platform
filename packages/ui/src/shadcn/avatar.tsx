...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        'bg-muted text-[#B8D4E3] flex size-full items-center justify-center rounded-md text-sm group-data-[size=sm]/avatar:text-xs',
        className,
      )}
      {...props}
    />
...
function AvatarGroupCount({
  ...
  return (
    <div
      ...
      className={cn(
        'bg-muted text-[#B8D4E3] ring-background relative flex size-8 shrink-0 items-center justify-center rounded-full text-sm ring-2 group-has-data-[size=lg]/avatar-group:size-10 group-has-data-[size=sm]/avatar-group:size-6 [&>svg]:size-4 group-has-data-[size=lg]/avatar-group:[&>svg]:size-5 group-has-data-[size=sm]/avatar-group:[&>svg]:size-3',
        className,
      )}
      {...props}
    />
