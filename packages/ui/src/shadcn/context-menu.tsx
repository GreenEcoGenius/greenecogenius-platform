...
function ContextMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        'text-[#B8D4E3] group-focus/context-menu-item:text-accent-foreground ml-auto text-xs tracking-widest',
        className,
      )}
      {...props}
    />
